...
export const ExpandIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const CollapseIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
